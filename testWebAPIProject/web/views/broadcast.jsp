...
<body>
	...
	<div id="chatbox" style="display: none;">
		<fieldset style="display:inline-block; width:65%; 
			...
			<button type="button" onclick="endBtn()">나가기</button>
		</fieldset>
		<fieldset style="display:inlin-block; width:15%;">
	...
	function connection(){
		webSocket = new WebSocket('ws://192.168.20.14:8088'+
		...
		webSocket.onopen = function(event){
			...
			// 메시지로 전달
			// 내가 보낼 때에는 send / 서버로 부터 받을 때에는 message
